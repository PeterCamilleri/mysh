...
module Mysh
  ...
  class Command
    ...
    HELP.add("", "General help on mysh.") do |args|
      show_handlebar_file(COMMAND_PATH + 'help.txt')
    end

    HELP.add("math", "Help on mysh math functions.") do |args|
      show_handlebar_file(COMMAND_PATH + 'help_math.txt')
    end

    HELP.add("=", "Help on mysh ruby expressions.") do |args|
      show_handlebar_file(COMMAND_PATH + 'help_expr.txt')
    end

    HELP.add("help", "Help on mysh help.") do |args|
      show_handlebar_file(COMMAND_PATH + 'help_help.txt')
    end
